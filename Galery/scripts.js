$(function(){
    ...
    let currentPhoto = 0;
     let imagesData = [
         {
             photo: 'images/01.jpg',
             title: 'Anax imperator LEACH, 1815 Óriás szitakötő, hím',
             description: 'Forrás: https://upload.wikimedia.org/wikipedia/commons/0/06/Anax_imperator_qtl2.jpg'
         },
         {
             photo: 'images/02.jpg',
             title: 'Anax imperator LEACH, 1815 Óriás szitakötő, nőstény',
             description: 'Forrás: http://www.habitas.org.uk/dragonflyireland/images/5630a.jpg'
         },
         {
             photo: 'images/03.jpg',
             title: 'Pipacsok',
